...
public class GenericDecisionTableTest {
  ...
  public void interval() {
    ...
    decisionTable.addCondition((r, f) -> r[1] == null || f <= r[1]);
  ...
  public void intervalWithMaps() {
    ...
    decisionTable.addCondition((r, f) -> r.get("max") == null || f <= r.get("max"));

    decisionTable.addRow(boundaries(40, 60), "boundaries1");
    decisionTable.addRow(boundaries(1, 100), "boundaries2");
    decisionTable.addRow(boundaries(null, null), "catchall");
  ...
  private final Map<String, Integer> boundaries(final Integer min, final Integer max) {
